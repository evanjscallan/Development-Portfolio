		...
		<React.Fragment>
			...
			<nav className={props.contactState ? 'nav-menu hidden' : 'nav-menu'}>
				...
				className={props.navState ? 'nav-a nav-icon flex-ctr-col' : 'nav-a-min nav-icon flex-ctr-col'}>
					<img src={props.navState ? xMark : hamburger} alt='hamburger'></img>
				...
				<p className={props.navState ? 'navDescrip-min' : 'navDescripA'}>Work</p>
				<p className={props.navState ? 'navDescrip-min' : 'navDescripB'}>Info</p>
				<p className={props.navState ? 'navDescrip-min' : 'navDescripC'}>Contact</p> 
				</div>
